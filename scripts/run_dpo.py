...
def main():
    ...
    ap.add_argument("--batch-size", type=int, default=None, help="覆盖 dpo.per_device_batch_size")
    ap.add_argument("--gradient-accumulation-steps", type=int, default=None,
                    help="覆盖 dpo.gradient_accumulation_steps")
    ...
    if args.batch_size is not None:
        ...
        cfg.dpo.per_device_batch_size = args.batch_size
    if args.gradient_accumulation_steps is not None:
        if args.gradient_accumulation_steps < 1:
            ap.error("--gradient-accumulation-steps 必须大于等于 1")
        cfg.dpo.gradient_accumulation_steps = args.gradient_accumulation_steps
